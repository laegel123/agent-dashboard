/**
 * Shared icons + formatters.
 * Port of design-package/agent-dashboard/project/dashboard-utils.jsx.
 *
 * Added in this port (★ not in design original):
 *   - `folder` icon — used by Detail drawer header (COMPONENTS.md, Phase 5.2)
 */
...
export type IconName =
  | 'pause' | 'play' | 'check' | 'x' | 'retry' | 'chat'
  | 'search' | 'plus' | 'branch' | 'gear' | 'dots' | 'arrow'
  | 'file' | 'bolt'
  | 'folder';  // ★ added
...
const ICON_PATHS: Record<IconName, string> = {
  ...
  // open-folder glyph (manila tab + body)
  folder: 'M3 6a1 1 0 0 1 1-1h4l2 2h6a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z',
};
...
export function StatusDot({ status, size = 8, style }: StatusDotProps) {
